        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.metaRow}>
             <View style={styles.tag}>
                 ...
                 <Text style={styles.tagText}>{artifact.year_created || artifact.era || "Đang cập nhật"}</Text>
             </View>
             <View style={styles.tag}>
             ...
             <View style={styles.infoGrid}>
                ...
                <View style={[styles.infoRow, {marginBottom: 0}]}>
                   ...
                   <View style={styles.infoItem}>
                      ...
                      <Text style={styles.infoValue}>{artifact.artifact_type || artifact.category || "Cổ vật"}</Text>
                   </View>
                </View>
             </View>
          </View>
